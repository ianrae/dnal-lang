...
public class OldGeneratorImpl implements OldGenerator {
...
//    }
    public OldGeneratorImpl(DTypeRegistry registry, World world, CompilerContext context, LineLocator lineLocator) {
